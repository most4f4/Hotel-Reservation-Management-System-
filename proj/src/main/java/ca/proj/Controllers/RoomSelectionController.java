...
public class RoomSelectionController implements Initializable {
    ...
    public void setBookingDetails(LocalDate checkIn, LocalDate checkOut, int numGuests) {
        ...
        numNights.setText(" ( "+ String.valueOf(nights) + (nights > 1 ? " Nights" : "Night") + " )");
    ...
    @FXML void nextButtonPressed(ActionEvent event) {
        ...
        GuestDetailsController controller = (GuestDetailsController) HotelReservationApplication.getControllers().get(SceneName.GuestDetails);
        ...
        getStage().setScene(HotelReservationApplication.getScenes().get(SceneName.GuestDetails));
